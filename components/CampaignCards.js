...
const CampaignCards = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  const remaindays = daysLeft(deadline);

  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      <Image unoptimized src={image} alt="fund" width={280} height={200} className="object-cover rounded-[15px]" />
      <div className="flex flex-col p-4 ">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">{remaindays}</h4>
            <p className="mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191]sm:max-w-[120px] truncate">
              Days Left
            </p>
          </div>
